...
class _FrequentlyState extends State<Frequently> {
  String dropdownMore = '';
  List<String> icon_Frequently = [];
  List<String> favorite = [];
  @override
  void initState() {
    // TODO: implement initState

    loadAsset('frequently').then((list) {
      setState(() {
        icon_Frequently = list;
        ...
        children: <Widget>[
          ...
          Positioned.fill(
              child: SingleChildScrollView(
                  ...
                  child: icon_Frequently.length > 0
                      ? ListView.builder(
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          padding: const EdgeInsets.all(8),
                          itemCount: icon_Frequently.length,
